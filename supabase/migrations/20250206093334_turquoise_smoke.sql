/*
  # Fix admin referrals constraints

  1. Changes
    - Clean up referrals referencing admin user
    - Update users referencing admin to use their own ID
...
DO $$ 
BEGIN
  -- First, delete any referrals where admin is the referrer
  DELETE FROM referrals
  WHERE referrer_id = 'a98be3f0-0000-4000-a000-000000000000';

  -- Update any users that reference the admin user to reference themselves
  UPDATE public.users
  SET referred_by = id
